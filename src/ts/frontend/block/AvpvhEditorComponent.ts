...
> {
	...
	public override render(): React.ReactNode {
		...
		const InspectorControls =
			// eslint-disable-next-line @typescript-eslint/no-unnecessary-condition, @typescript-eslint/no-deprecated -- In older versions of Gutenberg, InspectorControls was on editor
