	...
	public static function add() {
		...
		Script_And_Style_Helpers::add_script_configuration(
			...
			array(
				...
				'block_name'                 => esc_html__( 'Google Drive gallery', 'avpvh-gallery' ),
				'dir_counts'                 => $get_option( 'dir_counts' ),
				'dir_ordering'               => $get_ordering_option( 'dir_ordering' ),
				'grid_height'                => $get_option( 'grid_height' ),
				'grid_section_name'          => esc_html__( 'Image grid', 'avpvh-gallery' ),
				'grid_spacing'               => $get_option( 'grid_spacing' ),
				'image_ordering'             => $get_ordering_option( 'image_ordering' ),
				'lightbox_section_name'      => esc_html__( 'Image popup', 'avpvh-gallery' ),
				'nonce'                      => wp_create_nonce( 'avpvh_editor_plugin' ),
				'ordering_option_ascending'  => esc_html__( 'Ascending', 'avpvh-gallery' ),
				'ordering_option_by_name'    => esc_html__( 'By name', 'avpvh-gallery' ),
				'ordering_option_by_time'    => esc_html__( 'By time', 'avpvh-gallery' ),
				'ordering_option_descending' => esc_html__( 'Descending', 'avpvh-gallery' ),
				...
				'settings_override'          => esc_html__( 'Settings override', 'avpvh-gallery' ),
			)
		);
		Script_And_Style_Helpers::register_and_enqueue_style( 'avpvh_block', 'frontend/css/block.min.css' );
		register_block_type(
			'avpvh-gallery/gallery',
			array(
				'editor_script'   => 'avpvh_block',
