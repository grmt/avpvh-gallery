...
final class Shortcode {
	...
	public static function init() {
		...
		Script_And_Style_Helpers::register_script(
			'avpvh_imagelightbox_script',
			'bundled/imagelightbox.umd.js'
		);
		Script_And_Style_Helpers::register_style( 'avpvh_imagelightbox_style', 'bundled/imagelightbox.css' );
		Script_And_Style_Helpers::register_script(
			'avpvh_imagesloaded',
	...
	public static function html( $atts ) {
		wp_enqueue_script( 'avpvh_imagelightbox_script' );
		wp_enqueue_style( 'avpvh_imagelightbox_style' );
